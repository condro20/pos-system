...
<template>
    ...
    <AuthenticatedLayout>
        <template #header><h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Produk</h2></template>
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div class="flex justify-end gap-2 pt-4">
                        ...
                        <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-md" :disabled="form.processing">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
